  ...
  return (
    ...
    <div className={style.gridHeader}>
      ...
      <div className='layout-row'>
        ...
        <CustomButton text='Add Train' onClick={() => {  sessionStorage.setItem("Mode",Manager_SCREEN_MODES.CREATE);
            ...
            {props.filteredList.slice(props.page * props.rowsPerPage, props.page * props.rowsPerPage + props.rowsPerPage).map((req: trainDetailsGridDto) => (
              <TableRow key={req.trainId}>
                  ...
                  <Box className='layout-row'>
                    <Box>
                    <IconButton size='small' onClick={() => {props.handleAction(req.trainId.toString() ,Manager_SCREEN_MODES.VIEW) }}>
                          <Tooltip title="View">
                      ...
                      <Box>
                        <IconButton size='small' onClick={() => { props.handleAction(req.trainId.toString() ,Manager_SCREEN_MODES.EDIT) }}>
                          <Tooltip title="Edit">
                      ...
                      <Box>
                        <IconButton size='small' onClick={() => {props.handleAction(req.trainId.toString() ,Manager_SCREEN_MODES.DELETE)}}>
